...
from chirrp.rag_pipeline.embed_gemini import GeminiEmbedder
    ...
    *,
    ...
    if not rows_all:
        return {
            "status": "no_matches",
            "question": q,
            "message": "No confident local matches found.",
            "answer": None,
            "sources": [],
            "retrieved_count": 0,
        }
    ...
    if evidence_is_weak(rows_all):
        return {
            ...
            "question": q,
            "message": "Retrieved evidence is weak for this question. Try a more specific question.",
            "answer": None,
            "sources": [],
            "retrieved_count": len(rows_all),
        }

    rows = pick_top_docs(rows_all, docs_k=docs_k, chunks_per_doc=chunks_per_doc)
